...
execute_process(
  COMMAND "/opt/homebrew/bin/git" --git-dir=.git show-ref "release-1.11.0"
  WORKING_DIRECTORY "/Users/ub/Desktop/bypass-methods/build/_deps/googletest-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/ub/Desktop/bypass-methods/build/_deps/googletest-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/ub/Desktop/bypass-methods/build/_deps/googletest-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
